...
from .views import (
    ...
    CashfreeWebhookView, CashfreeHealthCheckView,
)
...
urlpatterns = [
    ...
    # ── Cashfree health check (debug endpoint)
    path('cashfree-health/', CashfreeHealthCheckView.as_view(), name='cashfree-health'),
]
