...
# Cashfree Base URL - defaults to production URL if not set
# Production: https://api.cashfree.com/pg
# Sandbox: https://sandbox.cashfree.com/pg (only for testing)
...
# Must be 'production' when using production credentials
...
# Log warning if Cashfree is not properly configured
if not CASHFREE_APP_ID or not CASHFREE_SECRET_KEY:
    import logging
    logger = logging.getLogger(__name__)
    logger.warning(
        'Cashfree is not configured. Set CASHFREE_APP_ID, CASHFREE_SECRET_KEY, and CASHFREE_WEBHOOK_SECRET environment variables.'
    )
